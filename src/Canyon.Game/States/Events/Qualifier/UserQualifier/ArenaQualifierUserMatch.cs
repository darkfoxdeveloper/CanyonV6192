...
namespace Canyon.Game.States.Events.Qualifier.UserQualifier
{
    ...
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<ArenaQualifierUserMatch>();
                                            ...
                                            ArenaQualifierUser obj2)
        {
            ...
            var msg = new MsgQualifyingInteractive
            {
        ...
        public async Task DestroyAsync(uint idDisconnect = 0, bool notStarted = false)
        {
            ...
            if (Player1 != null && Player1.Identity != idDisconnect && temp != null)
            {
                ...
                {
                    Interaction = MsgQualifyingInteractive.InteractionType.EndDialog,
                    Option = Winner == Player1.Identity ? 1 : 0,
                    Identity = Player1.Identity,
                    Name = Player1.Name,
                    Rank = Player1.QualifierRank,
        ...
        public async Task FinishAsync(Character winner, Character loser, uint disconnect = 0)
        {
            ...
            await BroadcastWorldMsgAsync(
                string.Format(StrArenicMatchEnd, strWin, strLose, winner.QualifierRank),
        ...
        public async Task DrawAsync()
        {
            ...
            await BroadcastWorldMsgAsync(string.Format(StrArenicMatchDraw, strLose1, strLose2),
                                                TalkChannel.Qualifier);
        ...
        {
            await SendAsync(new MsgArenicScore
            {
                Identity1 = Player1.Identity,
                Name1 = Player1.Name,
                Damage1 = Points1,
