...
{
    public sealed class MagicTypeOperation
    {
        ...
        public MagicOperation Operation;

        public MagicTypeOperation(DbMagictypeOp dbOp)
        {
            ...
            Operation = (MagicOperation)dbOp.MagictypeOp;
        ...
        private bool AppendMagic(ushort nMagicId)
        {
            if (Magics.Contains(nMagicId))
            {
                return false;
            }
