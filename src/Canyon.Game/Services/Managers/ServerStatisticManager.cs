...
namespace Canyon.Game.Services.Managers
{
    ...
    {
        private static ILogger logger = LogFactory.CreateLogger<ServerStatisticManager>();
        ...
        {
            logger.LogInformation($"Initializing Server Statistic Manager...");
        ...
        {
            await ServerDbContext.SaveRangeAsync(dynaGlobalDataCache.Values.ToList());
        }
    }
}
