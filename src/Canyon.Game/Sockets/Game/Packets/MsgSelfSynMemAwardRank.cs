...
{
    public sealed class MsgSelfSynMemAwardRank : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgSelfSynMemAwardRank>();
        ...
        public override async Task ProcessAsync(Client client)
        {
            ...
            if (gameEvent == null)
            {
                ...
                logger.LogWarning($"Invalid event {Event} for MsgSelfSynMemAwardRank");
                return;
            }
                ...
                default:
                    {
                        ...
                        logger.LogWarning($"MsgSelfSynMemAwardRank:{Event}:{Action} unhandled!");
                        break;
                    }
            }
        }
