...
{
    public sealed class MsgAuctionQuery : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgAuctionQuery>();
        ...
        {
            logger.LogDebug($"MsgAuctionQuery>> {Action}\n{JsonConvert.SerializeObject(this)}");
            /**
             * Duration
             *  0 Very Long
             *  1 Long
            ...
            switch (Action)
            {
                ...
                default:
                    {
                        logger.LogWarning("MsgAuctionQuery:{Action} not handled\n{Json}", Action, JsonConvert.SerializeObject(this));
                        break;
                    }
            }
        }
