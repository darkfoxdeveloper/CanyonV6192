...
namespace Canyon.Game.Sockets.Game.Packets
{
    ...
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgInteract>();
        private static readonly ILogger cheatLogger = LogFactory.CreateGmLogger("cheater");
                ...
                case MsgInteractType.Marry:
                    {
                        ...
                        await BroadcastWorldMsgAsync(string.Format(StrMarry, targetUser.Name, user.Name),
