...
{
    public sealed class MsgAuction : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgAuction>();
        ...
        public override async Task ProcessAsync(Client client)
        {
            switch (Action)
            {
                ...
                default:
                    {
                        logger.LogDebug($"MsgAuction>> {Action}\n{JsonConvert.SerializeObject(this)}");
                        break;
                    }
            }
        }
