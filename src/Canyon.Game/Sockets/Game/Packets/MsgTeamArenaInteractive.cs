...
using static Canyon.Game.Sockets.Game.Packets.MsgQualifyingInteractive;

namespace Canyon.Game.Sockets.Game.Packets
{
    public sealed class MsgTeamArenaInteractive : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgQualifyingInteractive>();
                ...
                case InteractionType.Inscribe:
                    {
                        if (user.IsInQualifierEvent())
                        {
                            ...
                            {
                                await user.SendAsync(StrEventCannotEnterTwoEvents);
                            }
                ...
                default:
                    {
                        ...
                        {
                            await client.SendAsync(new MsgTalk(client.Identity, TalkChannel.Service, $"Missing packet {Type}, Action {Action}, Length {Length}"));
                        }
