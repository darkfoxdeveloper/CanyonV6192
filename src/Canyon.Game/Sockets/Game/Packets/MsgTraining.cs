...
{
    public sealed class MsgTraining : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgTraining>();
        ...
        public override async Task ProcessAsync(Client client)
        {
            switch (Action)
            {
                ...
                default:
                    logger.LogWarning($"Unhandled MsgTraining::{Action}\r\n{PacketDump.Hex(Encode())}");
                    break;
            }
        }
    }
