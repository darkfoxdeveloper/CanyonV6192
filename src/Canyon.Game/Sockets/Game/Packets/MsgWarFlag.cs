...
{
    public sealed class MsgWarFlag : MsgBase<Client>
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgWarFlag>();
        ...
        public override async Task ProcessAsync(Client client)
        {
            ...
            switch (Action)
            {
                ...
                default:
                    {
                        logger.LogWarning("Packet action not found: {action}", Action);
                        break;
                    }
            }
        }
