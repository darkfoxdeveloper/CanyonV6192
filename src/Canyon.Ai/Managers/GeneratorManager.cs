...
namespace Canyon.Ai.Managers
{
    ...
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<GeneratorManager>();
        ...
        public static async Task<bool> AddGeneratorAsync(Generator generator)
        {
            ...
            {
                logger.LogError(e, "Add Generator error: {}", e.Message);
                return false;
            }
        ...
        public static void SynchroGenerators()
        {
            ...
            logger.LogInformation($"Total {count} NPCs sent to the game server!!!");
        }
