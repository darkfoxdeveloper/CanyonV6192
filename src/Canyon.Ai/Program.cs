...
namespace Canyon.Ai
{
    internal class Program
    {
        ...
        public static async Task<int> Main(params string[] args)
        {
            ...
            Console.WriteLine("\tCanyon: Ai Server");
            ...
            LogFactory.Initialize(Kernel.Services.LogProcessor, "Canyon.Ai");
            ...
            logger.LogInformation("Initializating realm '{RealmName}'", ServerConfiguration.Configuration.Ai.Name);

            logger.LogInformation("Checking if database '{}' is accessible", ServerConfiguration.Configuration.Database.Schema);
                        ...
                        case "/update_racepotion":
                            {
                                ...
                                logger.LogDebug($"Sum of potions chance: {debugTestSum}");
                                ...
                                logger.LogInformation($"Generators updated, please restart the server to take effect");
                                break;
                            }
#endif
                    }
