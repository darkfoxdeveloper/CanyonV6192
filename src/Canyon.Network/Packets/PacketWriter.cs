...
namespace Canyon.Network.Packets
{
    ...
    public sealed class PacketWriter : BinaryWriter, IDisposable
    {
        ...
        /// </summary>
        public PacketWriter() : base(new MemoryStream(), CodePagesEncodingProvider.Instance.GetEncoding(1252))
        {
            base.Write((ushort)0);
        }
        ...
        public void Write(string value, int fixedLength)
        {
            ...
            CodePagesEncodingProvider.Instance.GetEncoding(1252).GetBytes(value).CopyTo(array, 0);
            base.Write(array);
        }
