...
{
    public abstract class MsgAccServerHandshake<TActor>
        : MsgProtoBufBase<TActor, MsgAccServerHandshake<TActor>.HandshakeData> where TActor : TcpServerActor

    {
        ...
        public MsgAccServerHandshake()
            : base(PacketType.MsgAccServerHandshake)
        {
