...
namespace Canyon.Network.Packets
{
    ...
    {
        private static readonly ILogger logger = LogFactory.CreateLogger<MsgBase<TClient>>("DecodedMsg");
        ...
        {
            logger.LogInformation($"Process packet not being handled!!!\nPacketType: {Type} Length: {Length}");
