...
namespace Canyon.Network.Services
{
    /// <summary>
    ...
    public class RandomnessService : BackgroundService
    {
        ...
        {
            int random = await this.NextIntegerAsync(0, 999) + 1;
        ...
        public async Task NextBytesAsync(byte[] buffer)
        {
            ...
            {
                buffer[i] = (byte)await this.NextIntegerAsync(0, 255);
            }
        }

        public static Task<int> NextAsync()
        {
            if (Instance == null)
            {
                throw new NullReferenceException("Randomness Service has not been started.");
            }

            return Instance.NextIntegerAsync(0, int.MaxValue);
        }
        ...
        public static Task<int> NextAsync(int maxValue)
        {
            ...
            return Instance.NextIntegerAsync(0, maxValue);
        }
        ...
        public static Task<int> NextAsync(int minValue, int maxValue)
        {
            ...
            return Instance.NextIntegerAsync(minValue, maxValue);
        }

        public static Task<double> NextAsync(double range)
        {
            if (Instance == null)
            {
                throw new NullReferenceException("Randomness Service has not been started.");
            ...
            return Instance.NextRateAsync(range);
        }

        public static Task NextAsync(byte[] buffer)
        {
            if (Instance == null)
            {
                throw new NullReferenceException("Randomness Service has not been started.");
            ...
            return Instance.NextBytesAsync(buffer);
        }
    }
}
